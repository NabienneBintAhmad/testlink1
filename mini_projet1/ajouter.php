...
<div id="ajout">
    <form class="form-inline my-2 my-lg-0" method="POST" action="ajouter.php">
...
if(isset($_POST["submit"])){
    ...
    array_push($lists,array("Produits" =>$Produits,"Prix" =>$Prix,"Quantité" =>$Quantité));
